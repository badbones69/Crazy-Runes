...
public class SettingsManager {
	...
	public void setup(Plugin p) {
		...
		rfile = new File(p.getDataFolder(), "Runes.yml");
		if (!rfile.exists()) {
			try{
        		File en = new File(p.getDataFolder(), "/Runes.yml");
         		InputStream E = getClass().getResourceAsStream("/Runes.yml");
         		copyFile(E, en);
         	}catch (Exception e) {
         		e.printStackTrace();
         	}
		}
		runes = YamlConfiguration.loadConfiguration(rfile);
	...
	public FileConfiguration getRunes() {
		return runes;
	}
	...
	public void saveRunes() {
		try {
			...
			Bukkit.getServer().getLogger()
					.severe(ChatColor.RED + "Could not save Runes.yml!");
		}
	}
